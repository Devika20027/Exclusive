      ...
      <div className="wrapper">
        ...
        <div className="flex gap-[50px]">
          ...
          <div className="flex flex-col gap-[16px]">
            ...
            <div className="flex flex-col gap-[16px]">
              <div className="flex items-center gap-[8px]">
                ...
                <div className="flex items-center gap-[16px]">
                  <span className="font-poppinReg text-[14px] text-[#000] opacity-[50%]">
                    ({product.review})
                  </span>
                  <span className="w-[16px] h-0 border-[.5px] rotate-[90deg] border-[#000] opacity-[50%]"></span>
                  <div className={`${product.stock ? "" : "hidden"}`}>
                    <span className="font-poppinSemi text-[14px] text-[#00ff66] ">
                      In Stock
                    </span>
                  </div>
                  <div className={`${product.stock ? "hidden" : ""}`}>
                    <span className="font-poppinSemi text-[14px] text-[#d46666] ">
                      Out of Stock
                    </span>
                  </div>
                </div>
            ...
            <div>
              <p className="font-poppinReg text-[16px]">
            ...
            <div>
              <div className=" flex items-center gap-[16px] w-[400px] h-[90px] border-[rgba(0,0,0,.4)] border-[1px] rounded-t-[4px] pl-[16px] pt-[24px] pr-[20px] pb-[16px]">
                ...
                <div>
                  ...
                  <p className="text-[12px] font-poppinMed underline">
              ...
              <div className="flex items-center  gap-[16px] w-[400px] h-[90px] border-[rgba(0,0,0,.4)] border-[1px] border-t-0 rounded-b-[4px] pl-[16px] pt-[24px] pr-[20px] pb-[16px]">
                ...
                <div>
                  <h3 className="text-[16px] font-poppinMed">
                    Return Delivery
                  </h3>
                  <p className="text-[12px] font-poppinMed">
        ...
        <div className="mb-[100px] mt-[100px]">
          <div className="flex gap-[16px] items-center">
            ...
            <h3 className="font-poppinSemi text-[16px] text-[#DB4444]">
              Related Items
            </h3>
          </div>
        </div>
        <div
          className={`mt-[54px] mx-auto  pb-[30px] font-poppinSemi font-bold text-[36px] text-center ${
            filtered.length > 0 ? "hidden" : ""
          }`}
        >
          Oops No Related Items Found!!!
        </div>
            ...
            {filtered.map((item, index) => (
              <div key={index}>
                <div className="bg-[#F5F5F5] rounded-[4px] relative flex justify-center items-center h-[250px] container">
                  <div>
                    <Link to={`/product-details/${item.id}`}>
                      <img src={item.image} alt="Breed Dry Dog Food" />
                    </Link>
                  </div>
                  <div className="absolute top-[12px] right-[12px]">
                    <img src="/assets/images/Fill Heart.png" />
                    <img
                      src="/assets/images/Fill Eye.png"
                      className="mt-[10px]"
                    />
                  </div>
                  <div className={item.red}>
                    <div className="bg-[#db4444] px-[12px] py-[4px] rounded-[4px] text-[#FAFAFA] text-[12px] font-poppinReg absolute top-[12px] left-[12px]">
                      -{item.discount}%
                    </div>
                  </div>
                  <div>
                    <div
                      className={`bg-[#00FF66] px-[12px] py-[4px] rounded-[4px] text-[#FAFAFA] text-[12px] font-poppinReg absolute top-[12px] left-[12px] ${
                  ...
                  <button className="w-[100%] h-[41px] absolute bottom-[0px] bg-[#000] rounded-b-[4px] font-poppinMed text-[16px] text-[#fff] hidden cart">
                    Add to Cart
                  </button>
                </div>
                <h3 className="text-[16px] font-medium text-gray-800 pt-[15px] font-poppinMed">
                  {item.title}
                </h3>
                <div className="flex items-center text-yellow-500 text-sm pt-[5px]">
                  <p className="text-red-500 text-[16px] font-medium font-poppinReg pr-[10px]">
                    ${item.cost}
                  </p>
                  <span>
                    <img src={item.rating} />
                ...
                <div className="mt-[10px]">
                  <div class={item.colorDiv}>
                    <img src={item.color} alt={item.colorAlt} />
                  </div>
                </div>
              </div>
            ))}
